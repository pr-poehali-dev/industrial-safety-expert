...
const Index = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Анализ документации на техническое перевооружение, капитальный ремонт и ликвидацию ОПО",
    },
    {
      icon: "Settings",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 opacity-90">Промышленная безопасность под контролем. Начните с бесплатной консультации - мы оценим риски и предложим наилучший вариант действий!</p>
